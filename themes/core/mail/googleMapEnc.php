...
class PolylineEncoder {
	...
	public function init(array $points=array(), $numLevels = 18, $zoomFactor = 2, $verySmall = 0.00001, $forceEndpoints = true) {
		$this->points = $points;
	...
	public function GMapCirlce($Lat,$Lng,$Rad,$Detail=8){
		...
		$PolyEnc   = $this -> init($points);
		$EncString = $this -> dpEncode();
